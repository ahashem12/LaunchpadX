  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (email === "example@example.com" && password === "password") {
        ...
        isDev &&
          setDebugInfo(
            "Using mock authentication. Redirecting to dashboard..."
          );
      ...
      isDev &&
        setDebugInfo("Supabase auth successful. Redirecting to dashboard...");
      setTimeout(() => {
        router.push("/dashboard");
        router.refresh();
      }, 1000);
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-sm text-watermelon-green hover:underline"
              >
                Forgot password?
              </Link>
            </div>
