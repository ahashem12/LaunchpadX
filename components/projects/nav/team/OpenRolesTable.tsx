...
export function OpenRolesTable({ roles }: OpenRolesTableProps) {
  return (
    <div>
                ...
                <TableCell>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <Badge variant="outline" className="text-orange-500 border-orange-200">{role.role_category?.name.toUpperCase()}</Badge>
                    </div>
                  </div>
                </TableCell>
