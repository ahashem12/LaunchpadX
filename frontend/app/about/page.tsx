      ...
      <div className="container mx-auto px-4  relative">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            At ConsultAI, we're dedicated to democratizing access to
            high-quality business consulting. By leveraging cutting-edge AI
            technology, we provide instant, data-driven insights and expert
            advice to businesses of all sizes, helping them make better
